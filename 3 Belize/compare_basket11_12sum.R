...
k1 <- 209.7356016 #Lachnolaimus maximus
k2 <- 1116.59794 #Epinephelus striatus
BMSY1=0.5*k1
BMSY2=0.5*k2
...
species1 <- "hogfish (Lachnolaimus maximus)"
species2 <- "nassau grouper (Epinephelus striatus)"
