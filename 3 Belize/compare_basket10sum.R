...
final_result <- ggplot(success_long, aes(x = bio, y = total)) + # 
  ...
  geom_text(data = success_long%>% filter(fraction > 60), aes(label = fraction, 
                                                              x = bio, 
                                                              y = total), size = 2) +
...
final_result2 <- ggplot(success_long2, aes(x = bio, y = rev)) + # 
  ...
  #geom_label(aes(label = fraction), size = 5) + 
  #geom_text(hjust=1.5, vjust=0, size = 5/.pt)+
  geom_text(data = success_long2%>% filter(fraction > 60), aes(label = fraction,
...
ggsave(plot = final_result2, filename = here(fileplace, "all_results", "figures2", "figure2_basket10.png"), height = 5, width = 8)
...
final_result3 <- ggplot(success_long3, aes(x = bio, y = total)) + # 
  ...
  geom_text(data = success_long3%>% filter(fraction > 70), aes(label = fraction, x = bio, y = total), size = 2) + #success_long2 
  labs(title=success_title,
       subtitle=subtitle1,
...
ggsave(plot = final_result3, filename = here(fileplace, "all_results", "figures2", "profit1", "figure2_basket10.png"), height = 5, width = 8)
