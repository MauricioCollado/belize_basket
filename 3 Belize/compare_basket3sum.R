...
species1 <- "Schoolmaster"
species2 <- "Mangrove/Mahogany snapper"
species3 <- "Sailor's choice"
species4 <- "Margate"

#species1 <- "Schoolmaster (Lutjanus apodus	) "
#species2 <- "Mangrove/Mahogany snapper (Lutjanus mahogoni)"
#species3 <- "Sailor's choice (Haemulon parra)"
#species4 <- "Margate (Haemulon album)"
...
final_result <- ggplot(success_long, aes(x = bio, y = total)) + # 
  ...
  geom_text(data = success_long%>% filter(fraction > 65), aes(label = fraction, 
                                                                       x = bio, 
                                                                       y = total), size = 2) +
...
final_result2 <- ggplot(success_long2, aes(x = bio, y = rev)) + # 
  ...
  #geom_label(aes(label = fraction), size = 5) + 
  #geom_text(hjust=1.5, vjust=0, size = 5/.pt)+
  geom_text(data = success_long2%>% filter(fraction > 65), aes(label = fraction,
...
ggsave(plot = final_result2, filename = here(fileplace, "all_results", "figures2", "figure2_basket3.png"), height = 5, width = 8)
...
ggsave(plot = final_result3, filename = here(fileplace, "all_results", "figures2", "profit1", "figure2_basket3.png"), height = 5, width = 8)
