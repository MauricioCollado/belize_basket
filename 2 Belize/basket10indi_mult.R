...
t1 <- c(t=1, q1 = qi1, q2 = qi2_1) # subsistence
t2 <- c(t=2, q1 = qi7, q2 = qi2_2) # hand
t3 <- c(t=3, q1 = qi7, q2 = qi2_3) # pole
...
s1 <- c(s=1, r=0.3, K=k1, X=prop*k1, p=p1, tcoef=0) #analis
s2 <- c(s=2, r=0.4045, K=k2, X=prop*k2, p=p2, tcoef=0) #guttatus
