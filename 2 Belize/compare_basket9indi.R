...
subtitle1 <- "1 basket, 4 species, 1 gear type, indicator species quota"
...
npv <-  read_csv(here("2 single_sp", "basket9", "results", "npvcase.csv"))
...
all_rev1$s3 <- all_rev1$s2/rev_single$s3
all_rev1$s4 <- all_rev1$s2/rev_single$s4
