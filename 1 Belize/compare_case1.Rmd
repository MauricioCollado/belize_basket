...
write.table(na.omit(bios_all),here(fileplace, fileplace1,"results", "lut_gut_rev.csv"),
              row.names=FALSE, sep=",")
```
...
#general graphs
ggsave(plot = abio1, filename = here(fileplace, fileplace1, "figures", "species_results.png"), height = 5, width = 8)
ggsave(plot = abio2, filename = here(fileplace, fileplace1, "figures", "species_results.png"), height = 5, width = 8)
